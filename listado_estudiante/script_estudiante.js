  ...
  .then(data => {
    listaPersonas=data;
      ...
      data.forEach(persona => {
          ...
          fila.insertCell(6).innerText = persona.grado;
...
function abrirEditarPersona(cedula){
        ...
        const gradoInput = document.getElementById('grado-editable');
        gradoInput.value = personaFiltrada.grado;
}
