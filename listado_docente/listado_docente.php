        ...
        <dialog id="modal-insertar">
            ...
            <form id="formulario" method="POST" action="/my_school_app/listado_docente/almacenamiento_docente.php">
                <div class="grid">
                    ...
                    <div class="ladoIz">
                        <label for="EMAIL">ASIGNATURA</label>
                        ...
                        <option value="Lic. Matematicas">Lic. Matematicas</option>
                            ...
                            <option value="Lic. Religion">Lic. Religion</option>
                            <option value="Lic. Etica">Lic. Etica</option>
                            <option value="Lic. Educacion Fisica">Lic. Educacion Fisica</option>
                        </select>
                    </div>
                </div>
                <br>
            ...
            <form id="formulario" method="POST" action="/my_school_app/listado_docente/editar_docente.php">
                <div class="grid">
                    ...
                    <div class="ladoIz">
                        ...
                        <br><select class="form" name="asignatura" id="asignatura-editable" placeholder= "asignatura">
                            <option value="Lic. Matematicas">Lic. Matematicas</option>
                            <option value="Lic. Biologia">Lic. Biologia</option>
                            <option value="Lic. Informatica">Lic. Informatica</option>
                            <option value="Lic. Quimica">Lic. Quimica</option>
        ...
        <!--tabla docente-->
         <div class="container my-5">
            <div class="row">
                ...
                <table >
                    <tr>
                        <th colspan="9" class="titulo_tabla">LISTADO DOCENTE</th>
                    </tr>
                ...
                <table id="miTabla" class="table table-striped table-hover" style="width: 100%">
                    <thead >
                        <tr >
                            <th colspan="9" class="nuevo_usuario">
