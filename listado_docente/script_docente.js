  ...
  .then(data => {
    listaPersonas=data;
      ...
      data.forEach(persona => {
          ...
          fila.insertCell(6).innerText = persona.asignatura;
        ...
        // se llama la funcion para editar al hacer clic en el boton
          ...
          fila.insertCell(7).appendChild(botonEditar); 
          ...
          fila.insertCell(8).appendChild(botonEliminar);
      });
  })
...
function abrirEditarPersona(cedula){
        ...
        const asignaturaInput = document.getElementById('asignatura-editable');
        asignaturaInput.value = personaFiltrada.asignatura;
}
